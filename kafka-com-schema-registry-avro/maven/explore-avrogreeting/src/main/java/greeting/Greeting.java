...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7544996052116682605L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Greeting\",\"namespace\":\"greeting\",\"doc\":\"Avro sobre Suadação\",\"fields\":[{\"name\":\"greeting\",\"type\":\"string\"}]}");
   ...
   */
  public static greeting.Greeting.Builder newBuilder() {
    return new greeting.Greeting.Builder();
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static greeting.Greeting.Builder newBuilder(greeting.Greeting.Builder other) {
    if (other == null) {
      return new greeting.Greeting.Builder();
    } else {
      return new greeting.Greeting.Builder(other);
    }
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static greeting.Greeting.Builder newBuilder(greeting.Greeting other) {
    if (other == null) {
      return new greeting.Greeting.Builder();
    } else {
      return new greeting.Greeting.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(greeting.Greeting.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(greeting.Greeting other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.greeting)) {
        this.greeting = data().deepCopy(fields()[0].schema(), other.greeting);
    ...
    /**
      ...
      * @return This builder.
      */
    public greeting.Greeting.Builder setGreeting(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public greeting.Greeting.Builder clearGreeting() {
      greeting = null;
